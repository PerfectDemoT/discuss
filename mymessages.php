<?php
    ...
    $sql = "select * from messages where username='{$USER}' order by id desc limit $pageset,$pagesize " ;
    $res = mysqli_query($conn, $sql) ;
    
    $max_sql = "select * from messages where username='{$USER}'" ;
	...
	<div calss="container">
			...
			<div class="container-fluid">
				...
				<div class="collpse navcar-collapse" id="navbar-collapse1">
					<ul class="navbar-nav nav">
						...
						<li class="active">
							<a href="mymessages.php">查看我的留言</a>
						</li>
		...
		<div calss="row">
			...
			<!-- 下面是将数据库中的数据进行显示 -->
				...
				<ul class="pager">
    				<li class="previous"><a href="mymessages.php?page=1">&larr;首页</a></li>
    				<li><a href="mymessages.php?page=<?php echo $page<=1 ? 1 : $page-1 ;?>">上一页</a></li>
    				<li><a href="mymessages.php?page=<?php echo $page>=$pagemax ? $pagemax : $page+1 ;?>">下一页</a></li>
    				<li class="next"><a href="mymessages.php?page=<?php echo $pagemax?>">&rarr;尾页</a></li>
				</ul>				
			</div>
		</div>
